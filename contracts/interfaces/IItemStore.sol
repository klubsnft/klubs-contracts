...
interface IItemStore {
    ...
    event Sell(uint256 indexed metaverseId, address indexed addr, uint256 indexed id, address owner, uint256 price);
    ...
    function batchTransfer(uint256[] calldata metaverseIds, address[] calldata addrs, uint256[] calldata ids, address[] calldata to) external;

    function sales(uint256 metaverseId, address addr, uint256 id) external view returns (address seller, uint256 price);
    ...
    function sell(uint256[] calldata metaverseIds, address[] calldata addrs, uint256[] calldata ids, uint256[] calldata prices) external;
